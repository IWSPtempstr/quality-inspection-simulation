...
| A5-A8 | pending | AI checks and G8/A8 interface mapping defined in DEV_SPEC | A4 completed the bounded diagnosis agent and route behavior. A5 is next for Redis short memory and structured session compression. |
